...
server.listen(port, () => {// nếu muốn thay đổi cổng lắng nghe thì đổi ở đây mặc định mình để 3003 để tránh trùng với reactjs 
  console.log(`JSON Server is running with port http://localhost:${port}`)
})
